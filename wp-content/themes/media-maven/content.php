...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="category_list" style="margin-top:10px;">
		<?php if ( 'post' == get_post_type() ) : // Hide category and tag text for pages on Search ?>
			...
			<span class="cat-links">
				<!-- 显示文章分类 -->
				<?php printf( __( '<i class="icon-folder-open" title="文章分类" style="color:gray;"></i>&nbsp;%1$s', 'media-maven' ), $categories_list ); ?>
			</span>
		...
		<span class="comments-link">&nbsp;&nbsp;&nbsp;<i class="icon-comment" title="评论" style="color:gray;"></i>&nbsp;<?php comments_popup_link( __( 'Leave a comment&nbsp;&nbsp;&nbsp;', 'media-maven' ), __( '1 Comment', 'media-maven' ), __( '% Comments', 'media-maven' ) ); ?></span>
		<span class="sep"> </span>
		<?php endif; ?>
                <span class="comments-link">&nbsp;<i class="icon-eye-open" title="评论" style="color:gray;"></i>&nbsp;<a href="#"><?php if(function_exists('the_views')) {the_views();} ?></a></span>

		<?php edit_post_link( __( '&nbsp;&nbsp;&nbsp;<i class="icon-pencil" title="编辑" style="color:gray;"></i>&nbsp;Edit', 'media-maven' ), '<span class="edit-link">', '</span>' ); ?>
	</div>
	<footer class="entry-meta" style="height:20px;">
	</footer><!-- #entry-meta -->
