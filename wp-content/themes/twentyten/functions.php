...
function twentyten_posted_on() {
	printf( __('<span class="%1$s"><i title="发表时间" class="icon-calendar"></i></span> %2$s %3$s', 'twentyten' ),
		...
		sprintf( '<span class="author vcard" style="margin-left:10px;"><i title="文章作者" class="icon-user"></i><a class="url fn n" href="%1$s" title="%2$s">%3$s</a></span>',
...
function par_pagenavi($range = 9){   
    ...
    if($max_page > 1){
    	...
    	if($paged != 1){
    		echo "<a href='" . get_pagenum_link(1) . "' class='extend' title='&#36339;&#36716;&#21040;&#39318;&#39029;'> &#31532;&#19968;&#39029; </a>";
    	}    
    	previous_posts_link('<<');    
    	if($max_page > $range){    
        	if($paged < $range){
    	...
    	next_posts_link('>>');    
    	if($paged != $max_page){
    		echo "<a href='" . get_pagenum_link($max_page) . "' title='&#36339;&#36716;&#21040;&#26368;&#21518;&#19968;&#39029;'> &#26368;&#21518;&#19968;&#39029; </a><span>&#31532;".$paged ."&#39029;&#65288;&#20849;". $max_page ."&#39029;&#65289;</span>";
    	}
    }
} 