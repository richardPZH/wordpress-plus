...
<?php /* How to display posts of the Gallery format. The gallery category is the old way. */ ?>
	...
	<?php if ( ( function_exists( 'get_post_format' ) && 'gallery' == get_post_format( $post->ID ) ) || in_category( _x( 'gallery', 'gallery category slug', 'twentyten' ) ) ) : ?>
		<div style="margin-left:20px;margin-top:30px;" id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
...
<?php endif; ?>
		...
		<div id="tap" style="width:100%;height:20px;background-image: url('http://pengzhenghong.cn/wp-content/themes/twentyten/images/post-meta-bg.png');background-repeat: repeat;background-position: top left;background-attachment: fixed;border-top: 1px solid #e6e6e6;border-bottom: 1px solid #e6e6e6;"></div>
